...
SEE ALSO
    ...
    @undoSessionDecorator("Split States")
...
SEE ALSO
    ...
    @undoSessionDecorator("Sculpt Iterate")
...
SEE ALSO
    ...
    def undo(num_steps=1,*,_self=cmd):
        '''
DESCRIPTION

    "undo" restores the previous pymol state after an action.
...
ARGUMENTS
    ...
    steps = int: number of undoable actions to undo
...
SEE ALSO
    ...
    '''
        _self.dirty()
        with _self.lockcm:
            return _cmd.undo(_self._COb, int(num_steps))

    def redo(num_steps=1,*,_self=cmd):
        '''
DESCRIPTION

    "redo" restores an undone state.
...
ARGUMENTS
    ...
    steps = int: number of undone actions to redo
...
SEE ALSO
    ...
    '''
        _self.dirty()
        with _self.lockcm:
            return _cmd.redo(_self._COb, int(num_steps))
...
SEE ALSO
    ...
    '''
        r = DEFAULT_ERROR
        with _self.UndoGroupCM("Cycle Valence"):
            try:
                _self.lock(_self)
...
DESCRIPTION
    ...
    @undoSessionDecorator("Split Chains")
